 ...
 * writing.
 *
 * @param pb pointer to the AVIOContext where the hvcC is to be written
 * @param data pointer to the buffer containing the extradata needed to
 * write the hvcC
 * @param len size of the extradata buffer
